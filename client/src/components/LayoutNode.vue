...
// (today's mutations only ever replace one slot's content, never swap
// which slot two existing subtrees occupy -- todo.md's still-unimplemented
// "Swap dragged panel" would be exactly that) -- if that ever lands, it
// needs its own transition/identity handling, not a key change here.
