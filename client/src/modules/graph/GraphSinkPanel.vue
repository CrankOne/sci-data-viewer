<!--
  ...
  origin, the same {itemId, srcID, payloadType, snapshot} envelope every
  sink-dispatch snapshot builder produces (store/sinkDispatch.js) --
  deliberately origin-agnostic, same as :doc:`module-table`'s real consumer.
-->
<template>
  <NavBarEntity>
    <template #header>
